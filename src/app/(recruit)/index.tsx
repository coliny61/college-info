...
export default function RecruitHomeScreen() {
  ...
  const filteredSchools = useMemo(() => {
    ...
    // "Ranking" sort is a placeholder -- alphabetical fallback for now
...
// ---------------------------------------------------------------------------
// Styles (dynamic border-left color requires StyleSheet)
// ---------------------------------------------------------------------------
