...
// ---------------------------------------------------------------------------
// School Detail Screen (Parent View)
// ---------------------------------------------------------------------------

/**
 * School detail screen for the parent role group.
 * Reuses the same UI pattern as the recruit school detail screen.
 */
export default function ParentSchoolDetailScreen() {
  ...
  return (
    <SafeAreaView className="flex-1 bg-[#0F172A]">
      ...
      >
        ...
        {activeTab === 'Jersey' && (
          <JerseyContent school={school} schoolColors={currentTheme} />
        )}
      </ScrollView>
    </SafeAreaView>
  );
      ...
      <View className="bg-[#1E293B] rounded-xl p-4 mb-4">
        ...
        <View className="flex-row mt-2">
          <View className="flex-1">
            ...
            <Text className="text-white font-bold">{sport.record}</Text>
          </View>
          <View className="flex-1">
            <Text className="text-slate-500 text-xs">Conference</Text>
            <Text className="text-white font-bold">{sport.conference}</Text>
          </View>
          {sport.ranking && (
            <View className="flex-1">
              <Text className="text-slate-500 text-xs">Ranking</Text>
              <Text className="text-white font-bold">#{sport.ranking}</Text>
            </View>
          )}
        </View>
      </View>
